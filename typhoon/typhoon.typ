...
#set document(author: "Jefebus", title: "RSWC Super Stellar Typhoon")
...
El RSWC Super Stellar Typhoon nace de la necesidad de crear un 
...
Escarapelas del Consorcio Eurofighter:
